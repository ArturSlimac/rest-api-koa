...
-- AddForeignKey
ALTER TABLE `Orders` ADD CONSTRAINT `Orders_prchsrId_fkey` FOREIGN KEY (`prchsrId`) REFERENCES `Purchaser`(`id`) ON DELETE SET NULL ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE `Order_item` ADD CONSTRAINT `Order_item_ordrId_fkey` FOREIGN KEY (`ordrId`) REFERENCES `Orders`(`id`) ON DELETE SET NULL ON UPDATE CASCADE;
...
-- AddForeignKey
ALTER TABLE `Delivery_address` ADD CONSTRAINT `Delivery_address_ordrId_fkey` FOREIGN KEY (`ordrId`) REFERENCES `Orders`(`id`) ON DELETE RESTRICT ON UPDATE CASCADE;
...
-- AddForeignKey
ALTER TABLE `Box_order` ADD CONSTRAINT `Box_order_ordrId_fkey` FOREIGN KEY (`ordrId`) REFERENCES `Orders`(`id`) ON DELETE RESTRICT ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE `TrackTrace` ADD CONSTRAINT `TrackTrace_ordrId_fkey` FOREIGN KEY (`ordrId`) REFERENCES `Orders`(`id`) ON DELETE RESTRICT ON UPDATE CASCADE;
